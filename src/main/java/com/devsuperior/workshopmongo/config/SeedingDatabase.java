...
public class SeedingDatabase implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/**
		 * Mono = operação assíncrona reativa
		 * Void = não retorna valor, apenas sinaliza conclusão
		 */


		Mono<Void> deleteUsers = userRepository.deleteAll();
		/*
		Aqui a operação é realmente iniciada.
		Sem o subscribe(), o deleteAll() não executa.
		* */
